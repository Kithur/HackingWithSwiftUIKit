...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            currentAnswer.widthAnchor.constraint(equalTo: cluesLabel.widthAnchor, multiplier: 0.5),
    ...
    override func viewDidLoad() {
        ...
        performSelector(onMainThread: #selector(getter: view), with: nil, waitUntilDone: false)
    }
